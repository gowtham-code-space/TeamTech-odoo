  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight">System Compliance & Audit</h2>
              ...
              <tbody className="divide-y divide-slate-100">
                {audits.map((aud) => (
                  <tr key={aud.audit_id} className="hover:bg-slate-50/50 transition-colors">
                    <td className="px-6 py-4 font-mono font-semibold text-slate-500">{aud.audit_id}</td>
