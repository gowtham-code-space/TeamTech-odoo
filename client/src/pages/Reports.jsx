  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-extrabold text-slate-950 tracking-tight">System Reports</h2>
              ...
              <tbody className="divide-y divide-slate-100">
                {reports.map((rpt) => (
                  <tr key={rpt.report_id} className="hover:bg-slate-50/50 transition-colors">
                    <td className="px-6 py-4 font-mono font-semibold text-slate-600">{rpt.report_id}</td>
