  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-extrabold text-slate-950 tracking-tight">Resource Bookings</h2>
      ...
      {showAddForm && (
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm relative animate-fade-in space-y-4">
          ...
          <form onSubmit={handleCreateBooking} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            <div>
              <label className="block text-xs font-bold text-slate-400 uppercase mb-2">Resource (resource_id)</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-xs font-bold text-slate-400 uppercase mb-2">Start Time (start_time)</label>
              <input
                type="datetime-local"
                required
                value={startTime}
            ...
            <div>
              <label className="block text-xs font-bold text-slate-400 uppercase mb-2">End Time (end_time)</label>
              <input
                type="datetime-local"
                required
                value={endTime}
            ...
            <div className="md:col-span-2 lg:col-span-3">
              <label className="block text-xs font-bold text-slate-400 uppercase mb-2">Purpose of Booking</label>
              <textarea
              ...
              <tbody className="divide-y divide-slate-100">
                {bookings.map((booking) => (
                  <tr key={booking.booking_id} className="hover:bg-slate-50/50 transition-colors">
                    <td className="px-6 py-4 font-mono font-semibold text-slate-600">{booking.booking_id}</td>
