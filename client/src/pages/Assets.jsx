  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-extrabold text-slate-950 tracking-tight">Assets Management</h2>
      ...
      {showAddForm && (
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm relative animate-fade-in space-y-4">
          ...
          <form onSubmit={handleAddAsset} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            <div>
              <label className="block text-xs font-bold text-slate-400 uppercase mb-2">Asset Tag (asset_tag)</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-xs font-bold text-slate-400 uppercase mb-2">Asset Name (asset_name)</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-xs font-bold text-slate-400 uppercase mb-2">Category (category)</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-xs font-bold text-slate-400 uppercase mb-2">Location (location)</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-bold text-slate-400 uppercase mb-2">Status (status)</label>
              <select
                value={initialStatus}
              ...
              <tbody className="divide-y divide-slate-100">
                {assets.map((asset) => (
                  <tr key={asset.asset_id} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="px-6 py-4 font-mono font-medium text-slate-600">{asset.asset_tag}</td>
