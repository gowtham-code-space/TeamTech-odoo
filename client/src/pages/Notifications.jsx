      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        {viewState === 'success' && notifications.some(n => !n.is_read) && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200 rounded-xl font-bold text-xs shadow-sm cursor-pointer transition-all"
          >
              ...
              <div className="flex-1 min-w-0">
                ...
                {!ntf.is_read && (
                  <button
                    ...
                    className="mt-3 text-xs font-bold text-indigo-650 hover:text-indigo-500 transition-colors cursor-pointer"
                  >
                    Mark as read
                  </button>
                )}
