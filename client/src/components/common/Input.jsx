...
const Input = forwardRef(({
  ...
  // Input baseline style supporting light mode
  const baseInputStyle = 'w-full px-4 py-2.5 bg-white border text-slate-900 placeholder-slate-400 rounded-xl text-sm transition-all focus:outline-none focus:ring-2 disabled:bg-slate-100 disabled:text-slate-400 disabled:cursor-not-allowed';
