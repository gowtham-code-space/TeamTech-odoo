              ...
              <tr>
                <td colSpan={columns.length} className="px-6 py-12 text-center">
                  <div className="flex flex-col items-center justify-center space-y-2">
                    <RiInboxLine className="w-12 h-12 text-slate-350" />
                    <p className="text-sm font-semibold text-slate-450">{emptyMessage}</p>
                  </div>
                </td>
              </tr>
            ) : (
        ...
        <div className="px-6 py-4 border-t border-slate-200 bg-slate-50 flex items-center justify-between text-xs font-semibold text-slate-500 select-none">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-3 py-1.5 border border-slate-250 rounded-lg hover:bg-slate-100 disabled:opacity-40 disabled:hover:bg-transparent transition-colors cursor-pointer disabled:cursor-not-allowed text-slate-600"
            >
              Previous
            </button>
            <button
