...
export default function Navbar({ onToggleMobile }) {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white border-b border-slate-200 h-16 px-4 md:px-6 flex items-center justify-between shadow-sm transition-colors duration-200">
      {/* Mobile & Left Section */}
      <div className="flex items-center gap-4">
        {/* Mobile Toggle Trigger */}
        <button
          onClick={onToggleMobile}
          className="md:hidden p-2 rounded-lg text-slate-650 hover:text-slate-900 hover:bg-slate-100 transition-colors"
          title="Open Menu"
        >
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="relative p-2 rounded-xl text-slate-600 hover:text-slate-900 hover:bg-slate-100 transition-all duration-200 cursor-pointer"
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2.5 p-1 rounded-xl hover:bg-slate-100 transition-all duration-200 group text-left cursor-pointer"
          >
              ...
              <div className="absolute right-0 mt-2.5 w-56 rounded-xl bg-white border border-slate-200 shadow-xl py-2 z-50 animate-fade-in">
                ...
                <div className="p-1">
                  <button
                    ...
                    className="flex w-full items-center gap-2.5 px-3 py-2 text-sm text-slate-650 hover:text-slate-900 hover:bg-slate-50 rounded-lg transition-colors cursor-pointer"
                  >
                ...
                <div className="p-1">
                  <button
                    ...
                    className="flex w-full items-center gap-2.5 px-3 py-2 text-sm text-rose-600 hover:bg-rose-50 rounded-lg transition-colors font-medium cursor-pointer"
                  >
